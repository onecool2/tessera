...
public class RawTransactionTest {
    ...
    public void equalsAndHashCode() {
        ...
        RawTransaction othertxnDifferentNonce = new RawTransaction("OTHER".getBytes(), "KEY".getBytes(), new Nonce("Nonce".getBytes()), someKey);
        assertThat(txn).isNotEqualTo(othertxnDifferentNonce);

        RawTransaction othertxnDifferentFrom = new RawTransaction("OTHER".getBytes(), "KEY".getBytes(), nonce, PublicKey.from("OTHER".getBytes()));
